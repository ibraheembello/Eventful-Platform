    ...
    <div>
          ...
          {user?.role === 'CREATOR' && (
            <Link
              ...
              className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-indigo-600 to-purple-600
                text-white text-sm font-medium rounded-xl hover:from-indigo-700 hover:to-purple-700
      ...
      {loading ? (
        ...
        <div className="text-center py-20">
          ...
          <p className="text-lg text-[rgb(var(--text-secondary))]">No events found</p>
          {search && (
            <button
              type="button"
              onClick={() => setSearch('')}
            ...
            {events.map((event) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Event Info */}
                  <div className="p-5">
                    <h3 className="font-semibold text-lg text-[rgb(var(--text-primary))] group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors mb-2 line-clamp-2">
                      {event.title}
                    </h3>
